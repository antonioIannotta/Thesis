...
\subsection{Fairness assessment on G4 dataset}

It's important to report the fairness assessment computed on the G4 dataset. This assessment has been performed through the disparate impact metric over the protected attributes chosen in the data collection stage.

The results of this assessment has beeen that the dataset is unfair over the following protected attributes:

\begin{itemize}
    
    \item \emph{public\textunderscore private}

    \item \emph{f23}

    \item \emph{household\textunderscore income\textunderscore q}
