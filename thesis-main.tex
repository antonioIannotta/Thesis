...
After an exhaustive analysis of the dataset description provided by stakeholders, a comprehensive review revealed that certain aspects of the dataset could be optimized for our intended purposes. In this vein, a strategic decision has been made to remove 68 columns from the dataset.

The removal process was driven by the identification of intrinsic redundancy within the dataset. Several columns were found to contain overlapping or duplicative information, providing no additional value to our analysis. Moreover, a subset of columns exhibited poor semantic meaning and relevance to the specific objectives of our project.

By excising these 68 columns, we aim to refine the dataset and focus on the most essential and informative variables. This process is integral to enhancing the precision of our analyses, facilitating a more nuanced understanding of the data, and ultimately contributing to the success of our project.

This decision aligns with our commitment to optimizing the quality of the data at our disposal, ensuring that every variable retained serves a meaningful purpose in the context of our analysis. If you have any inquiries or would like further details on the column removal process, please feel free to reach out.
...
\begin{tabular}{|c|c|}
    ...
    \hline
    RandomForest Classifier  &  {'criterion': 'log\textunderscore loss', 'max\textunderscore depth': 40, 'max\textunderscore leaf\textunderscore nodes': 40, 'n\textunderscore estimators': 70} \\
    \hline
    LGB Classifier & {'learning\textunderscore rate': 0.1, 'min\textunderscore child\textunderscore samples': 30, 'n\textunderscore estimators': 300, 'num\textunderscore leaves': 40} \\
    \hline
    DecisionTree Classifier & {'criterion': 'gini', 'max\textunderscore depth': 30, 'max\textunderscore leaf\textunderscore nodes': 20} \\
    \hline
\end{tabular}
...
\begin{tabular}{|c|c|}
    ...
    \textbf{Model} & \textbf{Best parameters} \\
    \hline
    RandomForest Classifier  &  {'criterion': 'entropy', 'max\textunderscore depth': 40, 'max\textunderscore leaf\textunderscore nodes': 40, 'n\textunderscore estimators': 90} \\
    \hline
    LGB Classifier & {'learning\textunderscore rate': 0.05, 'min\textunderscore child\textunderscore samples': 20, 'n\textunderscore estimators': 100, 'num\textunderscore leaves': 20} \\
    \hline
    DecisionTree Classifier & {'criterion': 'gini', 'max\textunderscore depth': 10, 'max\textunderscore leaf\textunderscore nodes': 10} \\
    \hline
\end{tabular}
...
\begin{tabular}{|c|c|}
    ...
    \textbf{Model} & \textbf{Best parameters} \\
    \hline
    RandomForest Classifier  &  {'criterion': 'entropy', 'max\textunderscore depth': 10, 'max\textunderscore leaf\textunderscore nodes': 40, n\textunderscore estimators': 70} \\
    \hline
    LGB Classifier & {'learning\textunderscore rate': 0.05, 'min\textunderscore child\textunderscore samples': 20, 'n\textunderscore estimators': 100, 'num\textunderscore leaves': 20} \\
    \hline
    DecisionTree Classifier & {'criterion': 'gini', 'max\textunderscore depth': 10, 'max\textunderscore leaf\textunderscore nodes': 10} \\
