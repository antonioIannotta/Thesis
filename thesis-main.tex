...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item \emph{learning_rate}: [0.01, 0.05, 0.1]

        \item \emph{n_estimators}: [100, 200, 300]

        \item \emph{num_leaves}: [20, 30, 40]

        \item \emph{min_child_samples}: [10, 20, 30]
...
\begin{tabular}{|c|c|}
    ...
    \hline
    RandomForest Classifier  &  {'criterion': 'log_loss', 'max_depth': 40, 'max_leaf_nodes': 40, 'n_estimators': 70} \\
    \hline
    LGB Classifier & {'learning_rate': 0.1, 'min_child_samples': 30, 'n_estimators': 300, 'num_leaves': 40} \\
    \hline
    DecisionTree Classifier & {'criterion': 'gini', 'max_depth': 30, 'max_leaf_nodes': 20} \\
    \hline
\end{tabular}
...
\begin{tabular}{|c|c|}
    ...
    \textbf{Model} & \textbf{Best parameters} \\
    \hline
    RandomForest Classifier  &  {'criterion': 'entropy', 'max_depth': 40, 'max_leaf_nodes': 40, 'n_estimators': 90} \\
    \hline
    LGB Classifier & {'learning_rate': 0.05, 'min_child_samples': 20, 'n_estimators': 100, 'num_leaves': 20} \\
    \hline
    DecisionTree Classifier & {'criterion': 'gini', 'max_depth': 10, 'max_leaf_nodes': 10} \\
    \hline
\end{tabular}
...
\begin{tabular}{|c|c|}
    ...
    \textbf{Model} & \textbf{Best parameters} \\
    \hline
    RandomForest Classifier  &  {'criterion': 'entropy', 'max_depth': 10, 'max_leaf_nodes': 40, 'n_estimators': 70} \\
    \hline
    LGB Classifier & {'learning_rate': 0.05, 'min_child_samples': 20, 'n_estimators': 100, 'num_leaves': 20} \\
    \hline
    DecisionTree Classifier & {'criterion': 'gini', 'max_depth': 10, 'max_leaf_nodes': 10} \\
