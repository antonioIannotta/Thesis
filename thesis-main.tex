...
\begin{abstract}
    ...
    The research commenced with an exploration of pre-processing fairness techniques. To evaluate their efficacy, we employed a real-world education dataset from the Canary Islands. Comparative analysis was conducted between predictions generated using fair-by-design methods and those produced without fairness considerations. The results highlight the substantial impact of proactive fairness integration in system design.
