...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[node distance=2cm]
        ...
        \node (preproc) [startstop, left of=start, xshift=-2cm] {Pre-processing};
        \node (inproc) [startstop, below of=start] {In-processing};
        \node (postproc) [startstop, right of=start, xshift=2cm] {PostProcessing};
        ...
        \node (eo) [startstop, below of=eo] {Equalized Odds Post-processing};
