...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth, height=0.6\textwidth]{accuracy.png}
    \label{fig:acc_alg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth, height=0.6\textwidth]{dis.png}
    \label{fig:dis}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth, height=0.6\textwidth]{dir.png}
    \label{fig:dir}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth, height=0.6\textwidth]{dpds.png}
    \label{fig:dpds}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth, height=0.6\textwidth]{dpdr.png}
    \label{fig:dpdr}
