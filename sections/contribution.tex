...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[node distance=2cm]
        ...
        \node (choice) [decision, below of=start] {Starting point};
        ...
        \node (fns) [startstop, below of=dfg] {Fairness metric selection};
        \node (fms) [startstop, below of=fns] {Selection of the fairness notion that better aligns with fairness metric}
        \node (dfgfn) [startstop, below of=fn] {Definition of fairness goals};
        \node (fmst) [startstop, below of=dfgfn] {Understanding and study of the several fairness metrics};
        \node (end) [startstop, below of=fmst] {Selection of the fairness metric that better aligns with the fairness notion}
