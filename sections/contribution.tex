...
\subsection*{Comprehensive Fair-by-Design Workflow}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[node distance=2cm]
        ...
        \node (choice) [decision, below of=start, yshift=-1cm] {Starting point};
...
\textbf{Exploration of Protected Attributes:}
\begin{itemize}
...
\textbf{Feature Engineering Possibilities:}
\begin{itemize}
...
\textbf{Data Cleaning Strategies:}
\begin{itemize}
...
\textbf{Fairness-Aware Sampling Techniques:}
\begin{itemize}
...
\textbf{Discrete Protected Attributes:}
...
\textbf{Continuous Protected Attributes: Quantization Operation}
...
\textbf{Fairness through data augmentation}
\label{subsec:ftdr}
