...
\begin{figure}
    ...
    \begin{tikzpicture}[node distance=3cm]
        ...
        \node (pfi) [startstop, left of=start, xshift=-3cm] {Proactive Fairness \\ Integration};
        \node (te) [startstop, below of=start, xshift=-3cm] {Transparency and \\ Explainability};
        \node (uca) [startstop, below of=start, xshift=3cm] {User-Centered \\ Approach};
        \node (cmd) [startstop, right of=start, xshift=3cm] {Continuous Monitoring \\ and Development};
