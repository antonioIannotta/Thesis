...
\begin{table}
    ...
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
        ...
        \hline
        DA & XGB & 0.9975 & 0.9670 & 0.9813 & 0.9901 & 0.9340 & \cellcolor{red}0.0007 \\
        \hline
        DA & RF & 0.9987 & 0.9670 & 0.9770 & 0.9901 & 0.8610 & \cellcolor{red}0.0013 \\
        \hline
        FtU & XGB & 0.9987 & 0.9750 & 0.9813 & 0.9942 & 0.8610 & \cellcolor{red}0.0019 \\
        \hline
        FtU & RF & 0.9987 & 0.9697 & 0.9770 & 0.9901 & 0.8610 & \cellcolor{red}0.0013 \\
        \hline
        EG & XGB & 0.9944 & 0.9779 & 0.9743 & 0.9919 & 0.8622 & \cellcolor{red}0.0019 \\
        \hline
        EG & RF & 0.9987 & 0.9697 & 0.9770 & 0.9901 & 0.8610 & \cellcolor{red}0.0013 \\
        \hline
        \cellcolor{red}GS & \cellcolor{red}XGB & 0.5201 & 0.0000 & \cellcolor{red}0.0000 & 0.0000 & 0.0000 & 0.0759 \\
        \hline
        GS & RF & 0.9987 & 0.9697 & 0.9770 & 0.9901 & 0.8610 & \cellcolor{red}0.0013 \\
        \hline
    \end{tabular}
...
\begin{table}
    ...
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
        ...
        \hline
        \cellcolor{red}GS & \cellcolor{red}XGB & 0.5201 & 0.1204 & 0.0504 & 0.0556 & 0.0049 & 0.0759 \\
        \hline
...
\begin{table}
    ...
    \begin{tabular}{|c|c|c|}
        ...
        DA & 0.9975 & 0.9987 \\
        \hline
        \cellcolor{green}FtU & 0.9987 & 0.9987 \\
        \hline
        EG & 0.9944 & 0.9987 \\
        \hline
        \cellcolor{red}GS & 0.5201 & 0.9987 \\
        \hline
    \end{tabular}
...
\begin{table}
    ...
    \begin{tabular}{|c|c|c|}
        ...
        FtU & 0.9697 & 0.9750 \\
        \hline
        \cellcolor{green}EG & 0.9697 & 0.9779 \\
        \hline
        \cellcolor{red}GS & 0.0000 & 0.9697 \\
        \hline
    \end{tabular}
...
\begin{table}
    ...
    \begin{tabular}{|c|c|c|}
        ...
        FtU & 0.9770 & 0.9813 \\
        \hline
        \cellcolor{green}EG & 0.9743 & 0.9770 \\
        \hline
        \cellcolor{red}GS & 0.0000 & 0.9770 \\
        \hline
    \end{tabular}
...
\begin{table}
    ...
    \begin{tabular}{|c|c|c|}
        ...
        DA & 0.9901 & 0.9901 \\
        \hline
        \cellcolor{green}FtU & 0.9901 & 0.9942 \\
        \hline
        EG & 0.9901 & 0.9919 \\
        \hline
        \cellcolor{red}GS & 0.0000 & 0.9901 \\
        \hline
    \end{tabular}
...
\begin{table}
    ...
    \begin{tabular}{|c|c|c|}
        ...
        \textbf{FairAlg} & \textbf{Minimum value} & \textbf{Maximum Value} \\
        \hline
        \cellcolor{green}DA & 0.8610 & 0.9340 \\
        \hline
        FtU & 0.8610 & 0.8610 \\
        \hline
        EG & 0.8610 & 0.8622 \\
        \hline
        \cellcolor{red}GS & 0.0000 & 0.8610 \\
        \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|}
        ...
        FtU & 0.0056 & 0.0068 \\
        \hline
        \cellcolor{green}EG & 0.0049 & 0.0068 \\
        \hline
        \cellcolor{red}GS & 0.0068 & 0.1204 \\
        \hline
    \end{tabular}
...
\begin{table}
    ...
    \begin{tabular}{|c|c|c|}
        ...
        \textbf{FairAlg} & \textbf{Minimum value} & \textbf{Maximum Value} \\
        \hline
        \cellcolor{green}DA & 0.0026 & 0.0032 \\
        \hline
        \cellcolor{green}FtU & 0.0026 & 0.0032 \\
        \hline
        EG & 0.0032 & 0.0036 \\
        \hline
        \cellcolor{red}GS & 0.0032 & 0.0556 \\
        \hline
    \end{tabular}
...
\begin{table}
    ...
    \begin{tabular}{|c|c|c|}
        ...
        DA & 0.0014 & 0.0014 \\
        \hline
        \cellcolor{green}FtU & 0.0008 & 0.0014 \\
        \hline
        EG & 0.0012 & 0.0014 \\
        \hline
        \cellcolor{red}GS & 0.0014 & 0.0556 \\
        \hline
    \end{tabular}
...
\begin{table}
    ...
    \begin{tabular}{|c|c|c|}
        ...
        \textbf{FairAlg} & \textbf{Minimum value} & \textbf{Maximum Value} \\
        \hline
        \cellcolor{green}DA & 0.0011 & 0.0023 \\
        \hline
        FtU & 0.0023 & 0.0023 \\
        \hline
        EG & 0.0023 & 0.0023 \\
...
\begin{table}
    ...
    \begin{tabular}{|c|c|c|}
        ...
        \textbf{FairAlg} & \textbf{Minimum value} & \textbf{Maximum Value} \\
        \hline
        \cellcolor{green}DA & 0.0007 & 0.0013 \\
        \hline
        FtU & 0.0013 & 0.0019 \\
        \hline
        EG & 0.0013 & 0.0019 \\
        \hline
        \cellcolor{red}GS & 0.0013 & 0.0759 \\
        \hline
    \end{tabular}
